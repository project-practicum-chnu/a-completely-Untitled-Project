...
Стек технологій:
Backend: Python, Django, RESTful API, база даних PostgreSQL.
Frontend: React, Redux або Vuex, Axios, адаптивний дизайн.
...
3.	Таблиця "CourseEnrollments" (Записи на курси):
...
4.	Таблиця "CourseMaterials" (Матеріали курсу):
...
5.	Таблиця "Assignments" (Завдання):
...
6.	Таблиця "UserProgress" (Прогрес користувача):
...
7.	Таблиця "Certificates" (Сертифікати):
...
8.	Таблиця "Instructors" (Інструктори):
